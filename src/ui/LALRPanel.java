...
public class LALRPanel extends ProblemaPanel<LALR1> {
	...
	protected Problema<LALR1> problemaActual = null;
	...
	private class BotonGuardarActionListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			cadena2 = "<h1>" + nombregramatica +" &#9 &#9 Análisis LALR</h1>"+ "<br><h2>Producciones</h2>" + g.producciones.toString().replace("\n", "<br>")
					+ "<br>";

		
			
			cadena2 += "<br><h1>Conjuntos de items marcados</h1>";
			AnalisisLALR1 analisis = new AnalisisLALR1(g);
	...
	public void problema(Problema<LALR1> problema) {
