...
/**
* <b>Descripción</b><br>
* Clase que implementa las operaciones necesarias para trabajar con una gramática.
* <p>
* <b>Detalles</b><br>
* A través de esta clase se realizan todas las operaciones referentes a la gramática:creación, parseo, modificación, análisis.....<br>
* </p> 
...
public class Gramatica
{
  ...
  private Hashtable <String,NoTerminal> tNoTerminales;//Tabla de no terminales.
   ...
   * @param n Nombre de la gramática.
  **/
  ...
  **/
   ...
   * @param si Nombre del simbolo de inicio.
  **/
  ...
  **/
  ...
  /**Funcionq que obtiene si un terminal esta introducido en una gramatica.
 ...
 **@param p La produccion que se introduce en la gramatica.
 **/
  ...
  **@param p La produccion que se introduce al inicio de la gramatica.
  **/
  ...
  **@param nt Parte izquierda que tienen las producciones
  ...
  **@param i Posicion que se solicita.
  ...
  **@param vs Simbolos de los que se quiere calcular el FIRST
  ...
  **@param nt Simbolo del que se quiere calcular el FOLLOW
