...
* <p>
* <b>Detalles</b><br>
* Esta tabla es utilizada por el análisis sintáctico ascedente SLR1,LR1 y LALR1.<br>
* </p> 
...
{
  Hashtable <Integer,Hashtable <String,Vector <ElTablaAsc>>> tabla_principal;//Tabla principal.
  /**
   * Constructor básico.
  **/
   ...
   * @return t El terminal que se introduce. 
  **/
  private void introducirTerminalTablaAscendente(Terminal t)
  {
  	if(!VT.estaSimbolo(t))
  	{
   ...
   * @return t El no terminal que se introduce. 
  **/
  private void introducirNoTerminalTablaAscendente(NoTerminal nt)
  {
  ...
  **/
  private void introducirNuloTablaAscendente()
  {
   ...
   * @param nodo Fila donde se introduce el valor.
   * @param s Simbolo para el que se introduce el valor.
   * @param ac Elmento que se introduce.
  **/
