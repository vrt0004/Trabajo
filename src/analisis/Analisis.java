...
* <p>
* <b>Detalles</b><br>
* A trav�s de esta clase abstracta se representan las operaciones comunes a todas las simulaciones an�lisis sint�cticos.<br>
* </p> 
...
public abstract class Analisis
{
  ...
  **/
  protected VectorSimbolos entrada;
  /**Contenido actual de la entrada.
  **/
  protected VectorSimbolos entrada_actual;
  ...
  **/
  protected ISalidaAnalisis salida=null;
  /**
  ...
  **/
   ...
   * @param sa La clase que obtiene las salidas que genera esta clase.
  **/
  ...
  **/
   ...
   * @param ent Entrada que se simula.
  **/
   ...
   * @return El resultado del paso realizado. (PASO_REALIZADO,ANALISIS_FINALIZADO,PASO_NO_REALIZADO,ERROR_ANALISIS).
  **/
  ...
  **/
   ...
   * @param s Simbolo que se introduce en la pila.
  **/
  protected void insertarSimboloPila(Simbolo s)
  {
    pi.meterPila(s);
    if(salida!=null)
  ...
  **/
   ...
   * @param s Simbolo que se introduce en la entrada.
  **/
  ...
  **/
  protected void produccionSalida(Produccion pr)
  {
    ...
    for(int i=0;i<pr.obtenerParteDerecha().simbolosIntroducidos();i++)
  	{
  	  if(pr.obtenerSimboloParteDerecha(i).getClass().equals(Terminal.class)||pr.obtenerSimboloParteDerecha(i).getClass().equals(Nulo.class))
  	  {
  	    if(salida!=null)
   ...
   * @return "True" Si hay entrada para analizar o "False" si no hay entrada para analizar.
  **/
