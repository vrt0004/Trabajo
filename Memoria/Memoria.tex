...
\tutor{Dr. César Ignacio García Osorio \\ D. Álvar Arnaiz González}
\date{\today}
...
\noindent El Dr. César Ignacio García Osorio, profesor del departamento de Ingeniería Civil, área de Lenguajes y Sistemas Informáticos y D. Álvar Arnaiz González, profesor del departamento de Ingeniería Civil, área de Lenguajes y Sistemas Informáticos
...
Development of an application that obtains top-down parsing \textit{LL}(1) and botton-up parsing \textit{SLR}(1), \textit{LR}(1) and \textit{LALR}(1) from a grammar. The application obtains the \textit{FIRST} and \textit{FOLLOW} sets and the predictive parsing table and tables \textit{ACTION} and \textit{GOTO}. Moreover, it can be obtained for each diferent analyzes the trace of a string.
