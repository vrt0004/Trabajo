...
Development of an application that obtains top-down parsing LL(1) and botton-up parsing SLR(1), LR(1) and LALR(1) from a grammar. Obteins the FIRST and FOLLOW sets and the predictive parsing table and tables ACTION and GOTO .Also it can be obtained for each diferent analyzes the trace of a string .
